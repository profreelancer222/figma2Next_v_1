...
import search from '../../public/assest/svgFile/searchHeader.svg'
import userPlus from '../../public/assest/svgFile/userPlus.svg'
import chart from '../../public/assest/svgFile/chart.svg'
import train from '../../public/assest/svgFile/train.svg'
import community from '../../public/assest/svgFile/community.svg'
import bell from '../../public/assest/svgFile/bell.svg'

export default function header() {
   return <div className="ml-[200px] w-[1523px] h-[69px] px-8 py-3.5 bg-white justify-center items-center gap-8 inline-flex">
